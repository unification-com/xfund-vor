...
//
// Solidity: function getGasDepositsForConsumer(address _consumer) view returns(uint256)
func (_VorCoordinator *VorCoordinatorCaller) GetGasDepositsForConsumer(opts *bind.CallOpts, _consumer common.Address) (*big.Int, error) {
	var out []interface{}
	err := _VorCoordinator.contract.Call(opts, &out, "getGasDepositsForConsumer", _consumer)
...
//
// Solidity: function getGasDepositsForConsumer(address _consumer) view returns(uint256)
func (_VorCoordinator *VorCoordinatorSession) GetGasDepositsForConsumer(_consumer common.Address) (*big.Int, error) {
	return _VorCoordinator.Contract.GetGasDepositsForConsumer(&_VorCoordinator.CallOpts, _consumer)
}

// GetGasDepositsForConsumer is a free data retrieval call binding the contract method 0xda907ecf.
//
// Solidity: function getGasDepositsForConsumer(address _consumer) view returns(uint256)
func (_VorCoordinator *VorCoordinatorCallerSession) GetGasDepositsForConsumer(_consumer common.Address) (*big.Int, error) {
	return _VorCoordinator.Contract.GetGasDepositsForConsumer(&_VorCoordinator.CallOpts, _consumer)
}

// GetGasDepositsForConsumerProvider is a free data retrieval call binding the contract method 0x0e3b4216.
//
// Solidity: function getGasDepositsForConsumerProvider(address _consumer, bytes32 _keyHash) view returns(uint256)
func (_VorCoordinator *VorCoordinatorCaller) GetGasDepositsForConsumerProvider(opts *bind.CallOpts, _consumer common.Address, _keyHash [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _VorCoordinator.contract.Call(opts, &out, "getGasDepositsForConsumerProvider", _consumer, _keyHash)
...
//
// Solidity: function getGasDepositsForConsumerProvider(address _consumer, bytes32 _keyHash) view returns(uint256)
func (_VorCoordinator *VorCoordinatorSession) GetGasDepositsForConsumerProvider(_consumer common.Address, _keyHash [32]byte) (*big.Int, error) {
	return _VorCoordinator.Contract.GetGasDepositsForConsumerProvider(&_VorCoordinator.CallOpts, _consumer, _keyHash)
}

// GetGasDepositsForConsumerProvider is a free data retrieval call binding the contract method 0x0e3b4216.
//
// Solidity: function getGasDepositsForConsumerProvider(address _consumer, bytes32 _keyHash) view returns(uint256)
func (_VorCoordinator *VorCoordinatorCallerSession) GetGasDepositsForConsumerProvider(_consumer common.Address, _keyHash [32]byte) (*big.Int, error) {
	return _VorCoordinator.Contract.GetGasDepositsForConsumerProvider(&_VorCoordinator.CallOpts, _consumer, _keyHash)
}
...
//
// Solidity: function topUpGas(bytes32 _keyHash) payable returns(bool success)
func (_VorCoordinator *VorCoordinatorTransactor) TopUpGas(opts *bind.TransactOpts, _keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.contract.Transact(opts, "topUpGas", _keyHash)
}

// TopUpGas is a paid mutator transaction binding the contract method 0x3064e1cd.
//
// Solidity: function topUpGas(bytes32 _keyHash) payable returns(bool success)
func (_VorCoordinator *VorCoordinatorSession) TopUpGas(_keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.Contract.TopUpGas(&_VorCoordinator.TransactOpts, _keyHash)
}

// TopUpGas is a paid mutator transaction binding the contract method 0x3064e1cd.
//
// Solidity: function topUpGas(bytes32 _keyHash) payable returns(bool success)
func (_VorCoordinator *VorCoordinatorTransactorSession) TopUpGas(_keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.Contract.TopUpGas(&_VorCoordinator.TransactOpts, _keyHash)
}
...
// WithDrawGasTopUpForProvider is a paid mutator transaction binding the contract method 0x756b9606.
//
// Solidity: function withDrawGasTopUpForProvider(bytes32 _keyHash) returns(uint256 amountWithdrawn)
func (_VorCoordinator *VorCoordinatorTransactor) WithDrawGasTopUpForProvider(opts *bind.TransactOpts, _keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.contract.Transact(opts, "withDrawGasTopUpForProvider", _keyHash)
}

// WithDrawGasTopUpForProvider is a paid mutator transaction binding the contract method 0x756b9606.
//
// Solidity: function withDrawGasTopUpForProvider(bytes32 _keyHash) returns(uint256 amountWithdrawn)
func (_VorCoordinator *VorCoordinatorSession) WithDrawGasTopUpForProvider(_keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.Contract.WithDrawGasTopUpForProvider(&_VorCoordinator.TransactOpts, _keyHash)
}

// WithDrawGasTopUpForProvider is a paid mutator transaction binding the contract method 0x756b9606.
//
// Solidity: function withDrawGasTopUpForProvider(bytes32 _keyHash) returns(uint256 amountWithdrawn)
func (_VorCoordinator *VorCoordinatorTransactorSession) WithDrawGasTopUpForProvider(_keyHash [32]byte) (*types.Transaction, error) {
	return _VorCoordinator.Contract.WithDrawGasTopUpForProvider(&_VorCoordinator.TransactOpts, _keyHash)
}
...
// VorCoordinatorGasWithdrawnByConsumerIterator is returned from FilterGasWithdrawnByConsumer and is used to iterate over the raw logs and unpacked data for GasWithdrawnByConsumer events raised by the VorCoordinator contract.
type VorCoordinatorGasWithdrawnByConsumerIterator struct {
	Event *VorCoordinatorGasWithdrawnByConsumer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *VorCoordinatorGasWithdrawnByConsumerIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(VorCoordinatorGasWithdrawnByConsumer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *VorCoordinatorGasWithdrawnByConsumerIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *VorCoordinatorGasWithdrawnByConsumerIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// VorCoordinatorGasWithdrawnByConsumer represents a GasWithdrawnByConsumer event raised by the VorCoordinator contract.
type VorCoordinatorGasWithdrawnByConsumer struct {
	Consumer common.Address
	Provider common.Address
	Amount   *big.Int
	Raw      types.Log // Blockchain specific contextual infos
...
func (_VorCoordinator *VorCoordinatorFilterer) FilterGasWithdrawnByConsumer(opts *bind.FilterOpts) (*VorCoordinatorGasWithdrawnByConsumerIterator, error) {
	...
	return &VorCoordinatorGasWithdrawnByConsumerIterator{contract: _VorCoordinator.contract, event: "GasWithdrawnByConsumer", logs: logs, sub: sub}, nil
}
